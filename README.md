...
| **③ 訪問介護シフト改善シミュレーション** | 訪問介護の移動時間・時間重複・スタッフ負担を考慮し、現場制約を反映したシフト改善を検証した最適化ポートフォリオ。 | 業務改善 / 制約条件の整理 / 最適化の考え方 | [GitHub](https://github.com/toru-nishiwaki/home-care-shift-optimization) |
